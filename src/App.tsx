...
function App() {
    ...
    return (
        <>
            <header>
                <nav className="p-6 flex items-end fixed top-0 right-0">
                    <ModeToggle />
                </nav>
            </header>
            <main className="flex-auto min-w-0 mt-6 flex flex-col px-2 md:px-0">
                <section>
                    <h1 className="mt-16 mb-4 font-bold text-6xl">
                        Nana Osei Asiedu
                    </h1>
                    <p className="mb-4 text-3xl text-muted-foreground">
                        Junior at Calvin University with a passion for frontend
                        development and design. Sometimes I take pictures.
                    </p>
                </section>
                <section className="my-8">
                    ...
                    >
                        <div className="w-full flex flex-col gap-x-0 md:gap-x-2">
                            ...
                            <p className="text-lg text-muted-foreground m-0">
                                A mobile application to view, schedule and set
                                reminders for school events and gatherings.
                            </p>
                        </div>
                    </a>
                    <a
                    ...
                    >
                        <div className="w-full flex flex-col gap-x-0 md:gap-x-2">
                            ...
                            <p className="text-lg text-muted-foreground m-0">
                                A website to display movie and tv show info.
                    ...
                    >
                        <div className="w-full flex flex-col gap-x-0 md:gap-x-2">
                            ...
                            <p className="text-lg text-muted-foreground">
                                A natural language processing engine to analyze
                                various writing samples text analysis.
                            </p>
                        </div>
                    </a>
                </section>
